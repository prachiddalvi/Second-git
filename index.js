...
//      response.login.hello(newSessionId);
...
function put(request, response) {
        ...
        // TODO: refresh session id; similar to the post() function
        var cookies = request.cookies;
        var tempSid = cookies['session_id'];

        console.log("Old Session id: " + tempSid);

        var newSid = login.templogin(tempSid);

        login.logout(tempSid);
